package com.linyuzai.requestdialog.sweetalertdialog;
...
import com.linyuzai.requestdialog.R;

public class SuccessTickView extends View implements Animation.AnimationListener {
    ...
    public void setSize(float size) {
        CONST_RIGHT_RECT_W = dip2px(size);
        CONST_LEFT_RECT_W = CONST_RIGHT_RECT_W * 0.6f;
    }
    ...
    public void startTickAnim() {
        ...
        tickAnim.setAnimationListener(this);
        tickAnim.setDuration(duration);
    ...
    public void onAnimationStart(Animation animation) {
        if (onTickListener != null)
            onTickListener.onTickStart();
    }

    @Override
    public void onAnimationEnd(Animation animation) {
        if (onTickListener != null)
            onTickListener.onTickEnd();
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (onTickListener != null)
                    onTickListener.onDismiss();
            }
        }, dismissDuration);
    }
